<div style="background: linear-gradient(125deg, #e0e7ff, #f5f3ff, #fce7f3); padding: 30px; border-radius: 15px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333;">
